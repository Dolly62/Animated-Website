  ...
  const packages = [
    {
      ...
      yearlyPrice: 199,
      description:
        "A common form of Lorem reads: Lorem ipsm dolor sit amet, consectur adipiscing elit",
      green: rectangle18,
      pink: rectangle22,
    },
    {
          ...
          >
            ...
            <ul className="mt-4 space-y-2 px-4">
              <li className="flex gap-3 items-center">
                <img src={pkg.green} alt="Icon" className="w-4 h-4" />
                Videos of Lessons
              </li>
              <li className="flex gap-3 items-center">
                <img src={pkg.green} alt="Icon" className="w-4 h-4" />
              ...
              <li className="flex gap-3 items-center">
                <img src={pkg.pink} alt="Icon" className="w-4 h-4" />
                Monthly conferences
              </li>
              <li className="flex gap-3 items-center">
                <img src={pkg.pink} alt="Icon" className="w-4 h-4" />
