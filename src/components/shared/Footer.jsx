        ...
        <div className="md:w-1/2 space-y-8">
          ...
          <div>
            ...
            <input
              type="submit"
              value="Subscribe"
              className="px-4 py-2 bg-secondary rounded-md -ml-2 cursor-pointer hover:text-primary duration-300 transition-all"
            />
          </div>
        </div>
        ...
        <div className="md:w-1/2 flex flex-col md:flex-row flex-wrap justify-between gap-8 items-start">
          ...
          <div className="space-y-4 mt-5">
            ...
            <ul className="space-y-3">
              ...
              <p className=" hover:text-gray-300">qwuerybaihefv</p>
              <p className=" hover:text-gray-300">qiwu - hrebcl 095467</p>
            </ul>
          </div>
        </div>
      </div>
